...
> **角色**：PLAN 的唯一可勾选实施分解。
> **状态**：T01–T25、GATE-06、GATE-07、EXT-01 与 EXT-02 已完成。T23–T25 已收口。T26–T27 服务端与前端接线已完成；**OQ-120 开放**，独立 Review 与用户验收前两项任务保持未勾选。任务编号保留 T01–T53。
...
**OQ-120**（T26–T27 真实文案 10 项）当前开放，阻断页面最终收口；见 `requirements/SPEC.md` §6.7。最终小图标与部署参数分别在 T30、T34/T52 前确认。
...
- [x] **T24 · 管理端作品列表与角色化快速编辑**：按“设定图/出厂照”分区，维护顺序、主图、必要焦点/裁切，显示当前活动水印、已保存原图和真实公开预览；点击发布前自动保存页面当前修改，不恢复四角锚点。**实现、自动化、独立 Agent Review 与用户人工核验已收口。** _依赖：T23。_
...
- [ ] **T26 · 委托页与营业状态**：代表作品宽图、全装/半装范围、真实营业状态、人工估价说明、邮件行动、FAQ/约定入口；无站内表单、自动报价或未确认价目。**服务端与前端接线、自动化与实现方浏览器自测已完成；待 OQ-120 正式文案、独立 Review 与用户验收。** _依赖：T24。_
- [ ] **T27 · 关于、基本约定与联系页**：只写经用户确认的工作室事实、制作范围、官方渠道、基本约定和防诈骗信息；不虚构品牌故事，不复制竞品法律文本。**服务端与前端接线、空值隐藏、自动化与实现方浏览器自测已完成；待 OQ-120 正式文案、独立 Review 与用户验收。** _依赖：T24。_
