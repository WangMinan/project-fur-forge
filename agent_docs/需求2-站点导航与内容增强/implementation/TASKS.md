...
> **状态**：`GATE-01`、T01～T16、预验收修正 T15-F1～T15-F4、T17-F1～T17-F3 已关闭。T16-R1 新 SHA 独立复查和 T17 最终用户签署保持开放。
...
- `GATE-01`、T01～T16、T15-F1～T15-F4、T17-F1～T17-F3 已关闭；T16-R1 与 T17 保持开放。
