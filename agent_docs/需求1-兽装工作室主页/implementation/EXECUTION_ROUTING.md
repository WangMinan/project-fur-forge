...
> **生效日期**：2026-08-04（T23–T25 已收口；T26–T27 服务端完成，等待真实内容确认、前端与独立 Review）。
...
- T01–T25、GATE-06、GATE-07、EXT-01 与 EXT-02 已完成；T23–T25 独立 Agent Review 和用户人工验收均已收口。
- T26–T27 服务端迁移、受限 Schema、版本化管理 API、公开 `no-store` 投影和自动化已完成；两项任务仍未勾选，等待真实内容确认、前端、独立 Review 与用户验收。
...
- T26/T27：后端受限字段、委托/领养独立状态、管理 API 与公开投影已完成；下一步由用户确认真实内容，前端在现有首页管理入口接线并实现委托、关于、约定、联系，随后独立 Review；
