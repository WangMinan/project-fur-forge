import {
  ...
  reorderHeroSlidesRequestSchema,
} from '../../../../../../../shared/schemas/home'
import { createApiError } from '../../../../../../utils/api-error'
import { getDatabase } from '../../../../../../utils/database'
import { reorderEnabledHeroSlides } from '../../../../../../utils/runner/home-management'
...
export default defineEventHandler(async (event) => {
  const body = reorderHeroSlidesRequestSchema.safeParse(
  ...
  try {
    return adminHomeResponseSchema.parse({
      data: reorderEnabledHeroSlides(
        getDatabase().sqlite,
        body.data.expectedVersion,
        body.data.payload.slideIds,
        Date.now(),
