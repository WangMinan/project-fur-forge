...
> **角色**：PLAN 的唯一可勾选实施分解。
> **状态**：T01–T27、GATE-06、GATE-07、EXT-01 与 EXT-02 已完成。T26–T27 于 2026-08-04 完成新上下文独立 Review，结论 `PASS WITH FOLLOW-UP`；T26-F1 仍待统一独立 Review/用户验收。2026-08-05 用户追加 T27-F1 公开信息架构与政策页增量，当前按本清单实施。**OQ-120 已整批确认并登记为数据库初始化默认值。**任务编号保留 T01–T53，任务后缀用于用户确认后的同主题增量。

## 当前目标

从已经收口的作品、角色化媒体与常规领养链扩展到 P0 可部署核心。T23–T25 收口证据见 [`notes/t23-t25/T23-T25-CLOSURE-2026-08-04.md`](./notes/t23-t25/T23-T25-CLOSURE-2026-08-04.md)。T26–T27 服务端、前端与独立 Review 分别见 [`notes/t26-t27/T26-T27-BACKEND-HANDOFF-2026-08-04.md`](./notes/t26-t27/T26-T27-BACKEND-HANDOFF-2026-08-04.md)、[`notes/t26-t27/T26-T27-FRONTEND-2026-08-04.md`](./notes/t26-t27/T26-T27-FRONTEND-2026-08-04.md) 与 [`notes/t26-t27/T26-T27-INDEPENDENT-REVIEW-2026-08-04.md`](./notes/t26-t27/T26-T27-INDEPENDENT-REVIEW-2026-08-04.md)。当前先实现用户明确追加的 T27-F1；T26-F1 与 T27-F1 分别保留独立 Review/验收事实，再进入 T28/T29。T37 展会矩阵仍未实现。
...
- [ ] **T27-F1 · 公开信息架构、服务条款与隐私政策增量**：删除页脚重复联系方式，把版权与“服务条款 / 隐私政策 / ICP备案”放入右下信息区；“关于我们”在桌面以 Hover/键盘焦点二级导航、移动端以展开子项指向 `/about` `/service` `/privacy`；`/about` 合并邮件/QQ/抖音/防诈骗并放宽文章宽度，`/contact` 永久跳转到 `/about#contact`；原“基本约定”统一改称“服务条款”并单独落 `/service`，`/terms` 永久跳转；`/privacy` 使用 0015 新增受限纯文本字段与符合本站真实能力的默认值；`/commission` 状态框改为圆角矩形；`/adoptions` 在有内容和空状态时都显示 `business_statuses.adoption`。不得复制参考站原文，不新增万能 CMS、访客账号、表单、统计或备案号字段。**契约、0015、管理/公开 UI、定向自动化和双 Host 三视口实现方自测已完成；任务保持未勾选，等待新上下文独立 Review 与用户验收。** _依赖：T25、T27。_
