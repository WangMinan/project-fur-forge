...
> **角色**：PLAN 的唯一可勾选实施分解。
> **状态**：T01–T27、GATE-06、GATE-07、EXT-01 与 EXT-02 已完成。T26–T27 于 2026-08-04 完成新上下文独立 Review，结论 `PASS WITH FOLLOW-UP`；本轮 USER_GATE 为否，两项已勾选。**OQ-120 最终文字仍开放**，候选稿不得自动写入数据库。任务编号保留 T01–T53。

## 当前目标

从已经收口的作品、角色化媒体与常规领养链扩展到 P0 可部署核心。T23–T25 收口证据见 [`notes/t23-t25/T23-T25-CLOSURE-2026-08-04.md`](./notes/t23-t25/T23-T25-CLOSURE-2026-08-04.md)。T26–T27 服务端、前端与独立 Review 分别见 [`notes/t26-t27/T26-T27-BACKEND-HANDOFF-2026-08-04.md`](./notes/t26-t27/T26-T27-BACKEND-HANDOFF-2026-08-04.md)、[`notes/t26-t27/T26-T27-FRONTEND-2026-08-04.md`](./notes/t26-t27/T26-T27-FRONTEND-2026-08-04.md) 与 [`notes/t26-t27/T26-T27-INDEPENDENT-REVIEW-2026-08-04.md`](./notes/t26-t27/T26-T27-INDEPENDENT-REVIEW-2026-08-04.md)。当前 T26-F1 工程实现和实现方自测已完成，独立 Review/验收待执行；其后进入 T28/T29。T37 展会矩阵仍未实现。
...
- [ ] **T26-F1 · 委托页独立大图管理**：在“首页管理”增加“首页大图 / 委托页大图”Tab；以 `site_hero_slides.placement` 隔离两套集合，复用既有横竖双图上传、alt、排序、启停、私有水印预览和原子公开发布。委托页允许 0–5 项启用，但公开端只使用人工顺序第一项作为单张背景；0 项时隐藏且不得回退首页图。**2026-08-04 工程实现和实现方自测已完成；独立 Review 与用户验收待执行，不能改写 T26 既有历史结论。** _依赖：T26。_
