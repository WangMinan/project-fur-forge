...
.cover__locked { margin: 0 0 var(--admin-space-4); padding: var(--admin-space-3) var(--admin-space-4); border-radius: var(--admin-radius-md); color: var(--admin-status-info); background: var(--admin-status-info-soft); font-size: var(--admin-font-sm); }
