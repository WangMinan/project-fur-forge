...
import { deleteUpdate } from '../../../../utils/service/update'
...
export default defineEventHandler(async (event) => {
  ...
  if (!id.success || !body.success) {
    throw createApiError(400, 'VALIDATION_ERROR', 'Update delete request is invalid.')
  }

  try {
    return deleteUpdateResponseSchema.parse({
      data: deleteUpdate(
        getDatabase().sqlite,
        id.data,
