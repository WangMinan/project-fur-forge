...
- 在 1440×900、1024×900、768×1024、430×932 和 390×844 中，从章节起点进入视口后，无需第二次滚动即可同时理解章节标题、角色图、名称/物种、状态和唯一行动；可选价格存在时也进入同一信息闭环。
...
- 首页领养从章节起点进入视口后，同屏看到章节标题、角色、名称/物种、状态和唯一行动；
