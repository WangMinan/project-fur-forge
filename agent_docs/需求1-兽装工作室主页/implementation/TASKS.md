...
> **角色**：PLAN 的唯一可勾选实施分解。
> **状态**：T01–T25、GATE-06、GATE-07、EXT-01 与 EXT-02 已完成。T23–T25 已收口。T26–T27 服务端、首版前端与 2026-08-04 用户追加视觉/管理体验跟进已完成实现方复核；**OQ-120-5 的删改方向与 OQ-120-7 的业务原则已答，其余内容和最终文字仍开放**，独立 Review 与用户验收前两项任务保持未勾选。任务编号保留 T01–T53。

## 当前目标

从已经收口的作品、角色化媒体与常规领养链扩展到 P0 可部署核心。T23–T25 收口证据见 [`notes/t23-t25/T23-T25-CLOSURE-2026-08-04.md`](./notes/t23-t25/T23-T25-CLOSURE-2026-08-04.md)。T26–T27 服务端见 [`notes/t26-t27/T26-T27-BACKEND-HANDOFF-2026-08-04.md`](./notes/t26-t27/T26-T27-BACKEND-HANDOFF-2026-08-04.md)；前端见 [`notes/t26-t27/T26-T27-FRONTEND-2026-08-04.md`](./notes/t26-t27/T26-T27-FRONTEND-2026-08-04.md)。正式文案待 **OQ-120**；独立 Review 与用户验收前不得勾选；T37 展会矩阵仍未实现。
...
**OQ-120**（T26–T27 真实文案 10 项）中，OQ-120-5 的删改方向与 OQ-120-7 的逐单报价、邮件协商、著作权和一年保修原则已答；候选稿 v2 的最终文字及其余 8 项仍需用户确认并阻断页面最终收口。见 `requirements/SPEC.md` §6.7。候选稿不得自动写入数据库。最终小图标与部署参数分别在 T30、T34/T52 前确认。
...
- [ ] **T26 · 委托页与营业状态**：代表作品背景引导区、全装/半装范围、真实营业状态、人工估价说明、邮件行动、FAQ/约定入口；背景复用首页第一项双源图但不复制轮播，无图时整区隐藏；无站内表单、自动报价或未确认价目。**服务端、首版前端和 2026-08-04 视觉跟进已完成实现方浏览器复核。待 OQ-120 正式文案、独立 Review 与用户验收。** _依赖：T24。_
- [ ] **T27 · 关于、基本约定与联系页**：只写经用户确认的工作室事实、制作范围、官方渠道、基本约定和防诈骗信息；后台使用独立“文案配置”入口维护既有受限字段；不虚构品牌故事，不复制竞品法律文本。**服务端、首版前端和独立文案配置页已完成实现方复核；OQ-120 候选稿已登记但不得自动入库。待正式文案、独立 Review 与用户验收。** _依赖：T24。_
