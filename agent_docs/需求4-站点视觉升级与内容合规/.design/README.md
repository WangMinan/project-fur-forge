...
> **状态**：2026-08-26 仅阶段 E 开放；V09～V16、T47 与 Desktop/Mobile 静态 Gate 已完成。T47 本地/自动化 hard checks 全部通过；真实手机和最终人工视觉验收仍由 GATE-E 承担。
...
- 正式幕为 Type × Media scene：最多两件 READY 竖版出厂照，一次展示一件；双项提供循环上一项/下一项和连续编号，单项不显示伪控制或孤立编号。
