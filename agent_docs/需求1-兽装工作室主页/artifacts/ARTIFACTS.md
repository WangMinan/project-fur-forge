...
| 1 规格 | 需求规格 | `requirements/SPEC.md` | 已锁定 | 118 项 OQ 已收敛；2026-07-28 同步图片主导与新 OSS 处理链路的 20 MB/WebP+fallback 结果契约 |
| 2 计划 | 实施计划 | `planning/PLAN.md` | 已锁定 | 2026-07-28 更新为 Nuxt 4/Nitro/SQLite/OSS 单体技术路线；23 项 PLAN OQ 已收敛，统一 canonical、slug、草稿媒体与手动恢复边界 |
...
| 3 任务 | 任务清单 | `implementation/TASKS.md` | 已完成 | T01–T53 已正式拆解并建立依赖、验证、SPEC 覆盖和部署后置项；经 doc-coauthoring 三路无上下文 Reader Test 修订，实施均未开始 |
| 4 实施 | 实施备注 | `implementation/notes/README.md` | 未开始 | 文件仅保留阶段模板 |
