...
> **生效日期**：2026-08-04（T23–T27 已收口；T26-F1 工程实现与实现方自测完成，独立 Review/验收待执行）。
...
- T26-F1 已将委托页大图从首页集合拆分，并复用既有上传、排序与发布链路；实现方验证通过，任务保持未勾选，等待新上下文独立 Review 与用户验收。
...
- T26-F1：[工程完成，待独立 Review/验收] 委托页独立大图管理和公开投影；
- T28/T29：T26-F1 收口后由前端完成首页内容顺序、作品筛选、详情导航，后端补齐公开投影与重定向；
