...
> **生效日期**：2026-08-04（T23–T27 已收口；T26–T27 独立 Review 为 `PASS WITH FOLLOW-UP`，下一工程任务为 T28）。
...
- **OQ-120** 候选稿仍待用户确认并禁止自动入库，但不再阻断 T26/T27 工程任务；后台双上下文 409 与完整文案投影可由用户下班后补验。
...
- T26/T27：[已完成] 服务端、前端、独立 Review 与 findings 修复收口；OQ-120 仅作为正式内容门禁继续跟踪；
- T28/T29：下一步由前端完成首页内容顺序、作品筛选、详情导航，后端补齐公开投影与重定向；
