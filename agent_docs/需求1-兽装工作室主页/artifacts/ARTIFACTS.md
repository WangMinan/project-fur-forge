...
| 任务 | `implementation/TASKS.md` | T01–T27、EXT-01/02 与 GATE-06/07 已完成；T26–T27 独立 Review 为 `PASS WITH FOLLOW-UP` |
| 状态 | `STATE.md` | 阶段 C：下一工程任务 T28；OQ-120 继续作为正式内容门禁；main 直推继续生效 |
...
| `implementation/TASKS.md` | 当前 | 唯一可勾选清单；T26–T27 已勾选，下一工程任务为 T28 |
