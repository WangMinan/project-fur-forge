...
- T01–T20、GATE-06、GATE-07 与 EXT-02 已完成；T21 首次独立审查 NOT PASS，findings 已修复但仍未勾选，等待独立复审。
...
- [`T21-REVIEW-PREP.md`](./T21-REVIEW-PREP.md) 只准备独立第一垂直切片审查输入，不构成 T21 结论。
- [`T21-REVIEW-2026-08-01.md`](./T21-REVIEW-2026-08-01.md) 是首次独立审查结论（NOT PASS）及实现者修复记录；T21 结论必须由新的独立复审给出。
...
T21 findings 已完成实现者侧修复；当前只允许执行独立复审，不得提前进入 T22。后续记录必须说明长耗时任务的进度证据，以及 E2E 实际覆盖的用户路径和页面风险，不能只登记用例数量。
