...
- T01–T21、GATE-06、GATE-07 与 EXT-02 已完成；T21 首次独立审查、findings 修复、人工验收回归和最终用户确认已分层归档。
...
- [`T19-T20-UI-HANDOFF.md`](./T19-T20-UI-HANDOFF.md) 是 Kimi 接入公开页和首页管理页的工程交接。
- [`T19-T20-CLOSURE-2026-08-01.md`](./T19-T20-CLOSURE-2026-08-01.md) 记录最终工程审查、完整门禁、真实 OSS、空库迁移、泄漏扫描和精确清理。
- [`T21-REVIEW-PREP.md`](./T21-REVIEW-PREP.md) 是 T21 首次复审准备的历史清单，T21 收口后不再作为当前路由。
- [`T21-REVIEW-2026-08-01.md`](./T21-REVIEW-2026-08-01.md) 保留首次独立审查 NOT PASS 及 findings 修复记录。
- [`T21-MANUAL-UI-FIX-2026-08-02.md`](./T21-MANUAL-UI-FIX-2026-08-02.md) 记录人工验收回归、完整门禁和用户最终收口确认。
...
T21 已收口，下一任务为 T22；T22 完成前不得进入 T23。后续记录必须说明长耗时任务的进度证据，以及 E2E 实际覆盖的用户路径和页面风险，不能只登记用例数量。
