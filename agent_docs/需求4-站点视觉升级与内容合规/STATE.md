...
T37～T46-F7 已完成当前工程实现。T47 与 GATE-E 保持开放，用于真实手机、连续逐幕/reduced/performance、可访问性和王旻安/景宸人工视觉验收。
...
- 代表作品最多 2 件且必须有竖版出厂照；首页桌面左侧并排两张较小竖图，右侧为说明与唯一 `/works` 按钮，整幕保持一屏；`/works` 有出厂照时优先出厂照，完全没有时才回落领养横版封面。
