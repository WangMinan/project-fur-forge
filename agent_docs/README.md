...
- [`需求1-兽装工作室主页/`](./需求1-兽装工作室主页/)：阶段 4 已于 2026-07-28 获授权，T01 已完成，下一项为 T02。正式中文名已确认为“有点小狗工作室”，英文暂用 `dite dog`；适用领养/掉落作品一期公开人民币价格与作品短属性，永久私有原图上限为 30,000,000 字节并新增 OSS 配额门禁。当前已建立单 Nuxt 4 全栈应用的公开 SSR、后台 CSR、Nitro 健康检查和六个标准质量脚本；SQLite/Drizzle、认证与 OSS 尚未开始。公开端与管理端分别建立 Design Brief、信息架构和精确蓝色 Token 契约，v5 仅作为页面职责/交互基线；SPEC/PLAN 待答 OQ 均为 0。
