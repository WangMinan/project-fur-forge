...
| 任务 | `implementation/TASKS.md` | 已重排 | T01–T08 已完成；T09 为下一项；T09–T21 第一垂直切片 |
...
| 类型 | 路径 | 当前效力 |
| --- | --- | --- |
| 执行责任路由 | `implementation/EXECUTION_ROUTING.md` | 2026-07-30 当前生效；记录 Kimi 的 UI 主责、T09 当前批次及后续前后端交接，不属于产品契约 |
