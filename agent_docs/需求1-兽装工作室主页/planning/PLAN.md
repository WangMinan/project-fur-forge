...
> **状态**：2026-08-05 T27-F1 信息架构增量已完成实现方自测。T01–T27、GATE-06、GATE-07、EXT-01 与 EXT-02 已完成；T26-F1 与 T27-F1 均待新上下文独立 Review/用户验收。服务条款/隐私政策独立页、关于与联系合并、页脚法律区和领养状态公开呈现已经落地。
...
- 桌面“关于我们”二级导航由 CSS Hover 与 `:focus-within` 共同控制，移动菜单直接展示子项；页脚删除联系方式并把版权、服务条款、隐私政策和工信部备案入口放入右下信息区。
