...
- [`需求2-站点导航与内容增强/`](./需求2-站点导航与内容增强/)：已经落地的官方渠道、二维码、名称搜索、FAQ 和最新动态等历史增量。
...
需求1的媒体、安全、Host、部署和质量基线没有被放宽。需求2的官方五平台渠道、二维码和仍适用的名称搜索继续生效。
...
需求3文档已合入并于 2026-08-15 完成二次复查。应用代码、数据库和生产环境尚未实施需求3。
...
- 公开匿名上传必须有精确 CORS/Origin/token/TTL/限流；不能放宽管理员上传。
