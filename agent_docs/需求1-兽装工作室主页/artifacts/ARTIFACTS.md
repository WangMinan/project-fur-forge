...
- T51-F5 水印一致性修复：竖版详情与 3:4 卡片统一使用 480 px 水印参考宽度，后台公开水印预览继续复用同一处理串；像素变化生成新 `recipe-v3` 不可变身份，用户已确认真实 OSS 预览视觉正常；证据见 [`../implementation/notes/stage-e/T51-F5-ENGINEERING-2026-08-10.md`](../implementation/notes/stage-e/T51-F5-ENGINEERING-2026-08-10.md)。
- T51-F6 公共页脚备案布局：宽屏三块间距均衡，导航与备案组成中间区，右侧压缩为版权和法务/设计署名两行；本机测试按用户要求跳过，等待远端流水线验证；记录见 [`../implementation/notes/stage-e/T51-F6-FOOTER-LAYOUT-2026-08-11.md`](../implementation/notes/stage-e/T51-F6-FOOTER-LAYOUT-2026-08-11.md)。
- T51-F8 水印与精选流程：branding 改为单列 Logo、参数、保存刷新流程且不再设置真实预览门槛；作品端保留可选真实预览，精选以完整集合事务维护并公开前 12；本地工程门禁与三视口浏览器回归通过，独立 Review、用户验收、提交/推送/发布保持开放；证据见 [`../implementation/notes/stage-e/T51-F8-ENGINEERING-2026-08-14.md`](../implementation/notes/stage-e/T51-F8-ENGINEERING-2026-08-14.md)。
- T51-F9 首页/管理端动效与移动导航：两种大图 FLIP、管理端 `<1024px` 八入口抽屉、公开首页渐进增强动效、共用无障碍抽屉行为和双 Host/断点证据；本地门禁通过，远端 CI、T49-R1、用户验收和发布保持开放；证据见 [`../implementation/notes/t51-f9/T51-F9-ENGINEERING-2026-08-15.md`](../implementation/notes/t51-f9/T51-F9-ENGINEERING-2026-08-15.md)。
...
- T52-E2 OSS/ESA preflight：默认无网络 dry-run、显式 live 探测、Bucket/对象私有权限、上传失败面、原站/ESA 读取、共享阿里云凭据的官方 SDK purge 业务能力与脱敏证据；用户于 2026-08-10 明确允许排障期通配 CORS 并保留既有本地测试衍生对象，预检不再检查衍生 Bucket CORS 或全桶数据库一致性，也不清理旧对象；证据见 [`../implementation/notes/stage-e/T52-E2-ENGINEERING-2026-08-09.md`](../implementation/notes/stage-e/T52-E2-ENGINEERING-2026-08-09.md) 与 [`../implementation/notes/stage-e/T52-E2-PREFLIGHT-RELAXATION-2026-08-10.md`](../implementation/notes/stage-e/T52-E2-PREFLIGHT-RELAXATION-2026-08-10.md)，2026-08-10 的凭据收敛见 T52-E6 follow-up。
